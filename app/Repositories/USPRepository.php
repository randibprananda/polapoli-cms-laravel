...
class USPRepository
{
    ...
    public function __construct(USP $usp)
    {
        $this->model = $usp;
    }
    ...
    {
        $data = $this->model::where("status", "=", "1")->paginate(10)->withQueryString();
        return $data;
    }
    ...
    public function store($request)
    {
        try {
            ...
            try {
                ...
                return ["status" => "error", "message" => "error ketika create" . $th->getMessage()];
            }
        } catch (\Throwable $th) {
            return ["status" => "error", "message" => "error ketika keseluruhan" . $th->getMessage()];
        }
    }
