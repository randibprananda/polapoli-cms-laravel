...
@section('title', 'Division | Pola Poli')
        ...
        <div class="col-12">
            <div class="row justify-content-between gy-32">
                <div class="col-12 col-md-4">
                    <h4 class="h4">Division</h4>
                </div>
                <div class="col-12 col-md-7">
                    <div class="row g-16 align-items-center justify-content-end">
                        <div class="col-12 col-md-6 col-xl-4">
                            <form action="{{ route('dashboard.division.index') }}" method="get">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-16 px-24">
                    <h5 class="modal-title" id="modalDataLabel">Manage Division</h5>
                ...
                <form id="formData" method="POST" action="{{ route('dashboard.division.store') }}">
                    @csrf
                    <div id="method">
                        @method('POST')
                    </div>
...
@section('js')
    <script>
        ...
        function detailData(id = null) {
            ...
            if (id != null) {
                $.ajax({
                    url: "{{ route('dashboard.division.show', ':id') }}".replace(":id", id),
                    type: "GET",
        ...
        function updateData() {
            ...
            if (id != null && id != undefined) {
                ...
                $("#formData").attr("action", "{{ route('dashboard.division.update', ':id') }}".replace(":id", id));
        ...
        function deleteData() {
            ...
            if (id != null && id != undefined) {
                console.log("id = " + id);
                $("#formData").attr("method", "POST");
                $("#formData").attr("action", "{{ route('dashboard.division.destroy', ':id') }}".replace(":id", id));
