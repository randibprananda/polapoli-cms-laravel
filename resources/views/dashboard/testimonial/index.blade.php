...
@section('title', 'Testimonial | Pola Poli')
                ...
                <div class="col-12 col-md-7">
                    <div class="row g-16 align-items-center justify-content-end">
                        <div class="col-12 col-md-6 col-xl-4">
                            <form action="{{ route('dashboard.testimonial.index') }}" method="get">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $item->designation != null ? $item->designation : 'Not set' }}
                                        </td>
                                        <td>
                                            @if ($item->status == 1)
                                                <div
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-16 px-24">
                    <h5 class="modal-title" id="modalDataLabel">Manage Testimonial</h5>
                ...
                <form id="formData" method="POST" enctype="multipart/form-data"
                    action="{{ route('dashboard.testimonial.store') }}">
                    @csrf
                    <div id="method">
                        @method('POST')
                    </div>
...
@section('js')
    <script>
        ...
        function detailData(id = null) {
            if (id != null) {
                $.ajax({
                    url: "{{ route('dashboard.testimonial.show', ':id') }}".replace(":id", id),
                    type: "GET",
        ...
        function updateData() {
            ...
            if (id != null && id != undefined) {
                ...
                $("#formData").attr("action", "{{ route('dashboard.testimonial.update', ':id') }}".replace(":id", id));
        ...
        function deleteData() {
            ...
            if (id != null && id != undefined) {
                console.log("id = " + id);
                $("#formData").attr("method", "POST");
                $("#formData").attr("action", "{{ route('dashboard.testimonial.destroy', ':id') }}".replace(":id", id));
