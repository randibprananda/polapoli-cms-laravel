                ...
                <div class="col-12 col-md-7">
                    <div class="row g-16 align-items-center justify-content-end">
                        <div class="col-12 col-md-6 col-xl-4">
                            <form action="{{ route('dashboard.usp.index') }}" method="get">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-16 px-24">
                    <h5 class="modal-title" id="modalDataLabel">Manage USP</h5>
                ...
                <form id="formData" method="POST" enctype="multipart/form-data"
                    action="{{ route('dashboard.usp.store') }}">
                    @csrf
                    <div id="method">
                        @method('POST')
                    </div>
...
@section('js')
    <script>
        ...
        function detailData(id = null) {
            if (id != null) {
                $.ajax({
                    url: "{{ route('dashboard.usp.show', ':id') }}".replace(":id", id),
                    type: "GET",
        ...
        function updateData() {
            ...
            if (id != null && id != undefined) {
                ...
                $("#formData").attr("action", "{{ route('dashboard.usp.update', ':id') }}".replace(":id", id));
        ...
        function deleteData() {
            ...
            if (id != null && id != undefined) {
                console.log("id = " + id);
                $("#formData").attr("method", "POST");
                $("#formData").attr("action", "{{ route('dashboard.usp.destroy', ':id') }}".replace(":id", id));
