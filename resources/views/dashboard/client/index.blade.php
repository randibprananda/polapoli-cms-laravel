...
@section('title', 'Client | Pola Poli')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-16 px-24">
                    <h5 class="modal-title" id="modalDataLabel">Manage Client</h5>
...
@section('js')
    <script>
        ...
        function detailData(id = null) {
            if (id != null) {
                $.ajax({
                    url: "{{ route('dashboard.client.show', ':id') }}".replace(":id", id),
                    type: "GET",
        ...
        function updateData() {
            ...
            if (id != null && id != undefined) {
                ...
                $("#formData").attr("action", "{{ route('dashboard.client.update', ':id') }}".replace(":id", id));
        ...
        function deleteData() {
            ...
            if (id != null && id != undefined) {
                console.log("id = " + id);
                $("#formData").attr("method", "POST");
                $("#formData").attr("action", "{{ route('dashboard.client.destroy', ':id') }}".replace(":id", id));
